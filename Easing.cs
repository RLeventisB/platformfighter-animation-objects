 ...
 * File was taken from https://gist.github.com/Fonserbc/3d31a25e87fdaa541ddf
 */
...
public static class Easing
{
	...
	public class Elastic
	{
		...
		public static float InOut(float k)
		{
			float sin = MathF.Sin((k - 0.1f) * (2f * MathF.PI) / 0.4f);

			if ((k *= 2f) < 1f) return -0.5f * MathF.Pow(2f, 10f * (k -= 1f)) * sin;
			return MathF.Pow(2f, -10f * (k -= 1f)) * sin * 0.5f + 1f;
		}
	}
