...
namespace Editor.Objects
{
	...
	public class HitboxAnimationObject : IAnimationObject
	{
		...
		public HitboxAnimationObject(string name)
		{
			...
			Size = new Vector2KeyframeValue(this, Vector2.One * 16, PropertyNames.SizeProperty, false);
		...
		public bool IsBeingHovered(Vector2 mouseWorld, int? frame)
		{
			...
			return IsOnFrame(frame.Value) && MiscellaneousFunctions.IsInsideRectangle(Position.CachedValue, Size.CachedValue, mouseWorld);
		}
